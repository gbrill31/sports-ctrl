...
export default function GameManagement() {
  ...
  const closeEndGamePrompt = useCallback(() => dispatch(setEndGamePrompt(false)), [dispatch]);

  const endGame = useCallback(() => dispatch(updateGameEnd(activeGameId)), [dispatch, activeGameId]);
