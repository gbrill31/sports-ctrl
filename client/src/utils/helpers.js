export const convertSecToDuration = (
  sec,
  options = { showMin: true, showSec: true, showMil: true }
) => {
...
export const calcClockRemainingSeconds = (val) => {
  const minutes = val / 1000 / 60;
  return 60 * (minutes - Math.floor(minutes));
};

export const getClockFormat = (value) => {
